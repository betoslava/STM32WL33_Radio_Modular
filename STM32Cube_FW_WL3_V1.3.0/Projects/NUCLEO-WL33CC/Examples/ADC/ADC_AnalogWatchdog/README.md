...
- high threshold is set to Vref+/2 (3.3V/2=1.65V on NUCLEO-WL33CC), refer to literal ADC_AWD_THRESHOLD_HIGH.
...
Other peripherals used:
  ...
  1 GPIO for analog input: ADC channel P0 on pin PB.01 (Arduino connector CN7 pin 2 A1, Morpho connector CN3 pin 30)
