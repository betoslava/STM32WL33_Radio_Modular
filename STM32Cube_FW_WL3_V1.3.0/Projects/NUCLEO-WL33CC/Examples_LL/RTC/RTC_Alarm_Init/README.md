...
In this example, after start-up, SYSCLK is configured to the max frequency using PLL64M as clock source.
...
### <b>Directory contents</b>
  ...
  - RTC/RTC_Alarm_Init/Inc/stm32wl3x_it.h     Interrupt handlers header file
  ...
  - RTC/RTC_Alarm_Init/Src/stm32wl3x_it.c     Interrupt handlers
  - RTC/RTC_Alarm_Init/Src/main.c             Main program
  - RTC/RTC_Alarm_Init/Src/system_stm32wl3x.c STM32WL3x system source file
