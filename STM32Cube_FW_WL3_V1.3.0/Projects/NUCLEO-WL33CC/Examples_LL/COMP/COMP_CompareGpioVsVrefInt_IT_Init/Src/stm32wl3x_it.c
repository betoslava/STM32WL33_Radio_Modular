...
/**
  ******************************************************************************
  * @file    Examples_LL/COMP/COMP_CompareGpioVsVrefInt_IT_Init/Src/stm32wl3x_it.c
...
/**
  * @brief This function handles COMP global interrupt.
  */
void COMP1_IRQHandler(void)
{
  /* USER CODE BEGIN COMP1_IRQn 0 */
  ...
  /* USER CODE END COMP1_IRQn 0 */
  /* USER CODE BEGIN COMP1_IRQn 1 */

  /* USER CODE END COMP1_IRQn 1 */
}
