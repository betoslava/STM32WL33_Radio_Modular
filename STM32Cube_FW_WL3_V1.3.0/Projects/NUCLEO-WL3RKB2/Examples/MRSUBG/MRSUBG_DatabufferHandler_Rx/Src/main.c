...
/* USER CODE BEGIN PV */
__attribute__((aligned(4))) uint8_t vectcRxBuff[MSG_SIZE];
...
int main(void)
{
  ...
  /* Set the databuffers */
  __HAL_MRSUBG_SET_DATABUFFER0_POINTER((uint32_t)&vectcRxBuff[0]);
  __HAL_MRSUBG_SET_DATABUFFER1_POINTER((uint32_t)&vectcRxBuff[MSG_SIZE/2]);
