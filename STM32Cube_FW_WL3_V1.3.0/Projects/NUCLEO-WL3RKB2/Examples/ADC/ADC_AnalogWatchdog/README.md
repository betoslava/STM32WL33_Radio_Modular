...
- high threshold is set to Vref+/2 (3.3V/2=1.65V on NUCLEO-WL3RKB2), refer to literal ADC_AWD_THRESHOLD_HIGH.
...
Note: In this example, analog watchdog low threshold is set to 0V
      ...
      is not achievable unless customizing low threshold value.
...
Other peripherals used:
  ...
  1 GPIO for analog input: ADC channel P0 on pin PB.01 (Arduino connector CN7 pin 1 A0, Morpho connector CN3 pin 28)
...
### <b>Directory contents</b>
  ...
  - ADC/ADC_AnalogWatchdog/Inc/stm32wl3r_nucleo_conf.h     BSP configuration file
