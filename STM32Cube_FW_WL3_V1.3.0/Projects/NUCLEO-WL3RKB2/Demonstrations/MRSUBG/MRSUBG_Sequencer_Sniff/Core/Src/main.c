...
/**
  ...
  * @brief   This code implements an RX in sniff mode via the MRSUBG_Sequencer.
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
  ...
  /* Trigger sequencer */
  printf("Triggering Sequencer!\r\n");
  LL_MRSubG_Sequencer_Trigger();
...
static void MX_MRSUBG_Init(void)
{
  ...
  */
  ...
  MRSUBG_RadioInitStruct.outputPower = 12;
