...
#define BINARYSAMPLING_GPIO_PORT_SLAVE_MISO                   GPIOA
#define BINARYSAMPLING_GPIO_PORT_SLAVE_NSS                    GPIOA
#define BINARYSAMPLING_GPIO_PIN_SPI_SLAVE_SCK                 LL_GPIO_PIN_6
#define BINARYSAMPLING_GPIO_PIN_SPI_SLAVE_MISO                LL_GPIO_PIN_8
#define BINARYSAMPLING_GPIO_PIN_SPI_SLAVE_NSS                 LL_GPIO_PIN_9
...
#define BINARYSAMPLING_SPI_SLAVE                              SPI3
#define BINARYSAMPLING_LL_SPI_Slave_EnableClock()             LL_APB1_GRP1_EnableClock(LL_APB1_GRP1_PERIPH_SPI3)
#define BINARYSAMPLING_SPI_SLAVE_IRQn                         SPI3_IRQn
#define BINARYSAMPLING_SPI_SLAVE_IRQHandler                   SPI3_IRQHandler
#define BINARYSAMPLING_LL_DMAMUX_REQ_SPI_SLAVE_TX             LL_DMAMUX_REQ_SPI3_TX
