...
/**
  * @brief This function handles MRSUBG_TIMER CPU Wakeup interrupt.
  */
void MRSUBG_TIMER_CPU_WKUP_IRQHandler(void)
{
  /* USER CODE BEGIN MRSUBG_TIMER_CPU_WKUP_IRQn 0 */

  /* USER CODE END MRSUBG_TIMER_CPU_WKUP_IRQn 0 */
  HAL_MRSUBG_TIMER_CPU_WKUP_IRQHandler();
  /* USER CODE BEGIN MRSUBG_TIMER_CPU_WKUP_IRQn 1 */

  /* USER CODE END MRSUBG_TIMER_CPU_WKUP_IRQn 1 */
}
