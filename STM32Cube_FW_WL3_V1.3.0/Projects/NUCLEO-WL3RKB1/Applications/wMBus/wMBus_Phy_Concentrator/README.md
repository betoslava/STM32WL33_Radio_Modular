---
pagetitle: Readme for STM32CubeWL3R wM-Bus Phy Concentrator
lang: en
...
|-----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| T1C1_ACTIVATED_C1_MODE            | Activate   single protocol (Radio + packet) RX configuration for T1 + C1 gateway   reception only if C-mode is set (to be removed for other modes) |
