...
This example demonstrates the transmitter side and requires another device as a receiver. The receiver example is located under the NUCLEO-WL3RKB1\Demonstrations\MRSUBG\MRSUBG_Sequencer_Sniff folder.
