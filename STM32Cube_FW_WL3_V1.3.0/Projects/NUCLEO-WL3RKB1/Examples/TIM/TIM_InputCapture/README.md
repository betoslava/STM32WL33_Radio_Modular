...
How to use the TIM peripheral to measure an external signal frequency.
  ...
  SystemCoreClock is set to 64MHz for STM32WL3RKBVx Devices.

  TIM2 is configured in Input Capture Mode: the external signal is connected to 
  TIM2 Channel4 used as input pin.
...
### <b>Directory contents</b>
  ...
  - TIM/TIM_InputCapture/Inc/stm32wl3r_nucleo_conf.h     BSP configuration file
