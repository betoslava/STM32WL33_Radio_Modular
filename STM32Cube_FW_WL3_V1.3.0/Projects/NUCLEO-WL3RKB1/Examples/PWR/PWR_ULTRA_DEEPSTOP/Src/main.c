...
/**
  ******************************************************************************
  * @file    PWR/PWR_ULTRA_DEEPSTOP/Src/main.c
...
volatile uint32_t led2_toggle_period  = LED_TOGGLE_DELAY;
...
/* USER CODE BEGIN PV */
PWR_ULTRA_DEEPSTOPTypeDef sConfigUltraDeepStop;
...
int main(void)
{
  ...
  sConfigUltraDeepStop.BORStatus = ENABLE;
  sConfigUltraDeepStop.WakeUpPinStatus = ENABLE;
  sConfigUltraDeepStop.WakeUpPol = LL_PWR_WUP_FALLEDG;
  
  HAL_PWR_ConfigUltraDeepStop(&sConfigUltraDeepStop);
  
  /* Clear all related wakeup flags*/
  __HAL_PWR_CLEAR_FLAG(PWR_SDWN_WUF_WUF);
  
  /* Enter the ULTRA-Deepstop mode */
