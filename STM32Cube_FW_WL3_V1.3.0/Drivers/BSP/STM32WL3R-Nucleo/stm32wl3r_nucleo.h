...
/* Includes ------------------------------------------------------------------*/
#include "stm32wl3r_nucleo_conf.h"
#include "stm32wl3r_nucleo_errno.h"

/** @addtogroup BSP
  * @{
  */

/** @addtogroup STM32WL3R_NUCLEO
  * @{
  */

/** @addtogroup STM32WL3R_NUCLEO_COMMON
  * @{
  */

/** @defgroup STM32WL3R_NUCLEO_COMMON_Exported_Types STM32WL3R_NUCLEO COMMON Exported Types
  * @{
  */
typedef enum
{
...
/** @defgroup STM32WL3R_NUCLEO_COMMON_Exported_Constants STM32WL3R_NUCLEO COMMON Exported Constants
  * @{
  */
...
#define STM32WL3R_NUCLEO_BSP_VERSION       ((STM32WL3R_NUCLEO_BSP_VERSION_MAIN << 24U)\
                                            ...
                                            |(STM32WL3R_NUCLEO_BSP_VERSION_RC))

#define STM32WL3R_NUCLEO_BSP_BOARD_NAME  "NUCLEO_WL3RKB"
#define STM32WL3R_NUCLEO_BSP_BOARD_ID    "NUCLEO$WL3RKB"

/** @defgroup STM32WL3R_NUCLEO_COMMON_LED STM32WL3R_NUCLEO COMMON LED
  * @{
  */
#define LEDn                                   3U
...
/** @defgroup STM32WL3R_NUCLEO_COMMON_BUTTON STM32WL3R_NUCLEO COMMON BUTTON
  * @{
  */
#define BUTTONn                            3U
...
#if (USE_BSP_COM_FEATURE == 1)
/** @defgroup STM32WL3R_NUCLEO_COMMON_COM STM32WL3R_NUCLEO COMMON COM
  * @{
  */
#define COMn                                    1U
...
#define COM1_RX_PIN                             GPIO_PIN_14
...
/** @addtogroup STM32WL3R_NUCLEO_COMMON_Exported_Variables
  * @{
  */
#if (USE_BSP_COM_FEATURE == 1)
...
/** @addtogroup STM32WL3R_NUCLEO_COMMON_Exported_Functions
  * @{
  */
...
/** @addtogroup STM32WL3R_NUCLEO_COMMON_LED_Functions
  * @{
  */
...
/** @addtogroup STM32WL3R_NUCLEO_COMMON_BUTTON_Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE == 1)
/** @addtogroup STM32WL3R_NUCLEO_COMMON_COM_Functions
  * @{
  */
