/**
  ******************************************************************************
  * @file    stm32wl3r_nucleo.c
  * @author  MCD Application Team
  * @brief   This file provides set of firmware functions to manage:
  *          - LEDs and push-button available on STM32WL3R-Nucleo Kit
...
/** @defgroup STM32WL3R_NUCLEO_COMMON STM32WL3R_NUCLEO COMMON
  * @brief This file provides set of firmware functions to manage Leds and push-button
  *        available on STM32WL3R-Nucleo Kit from STMicroelectronics.
  * @{
  */

/** @defgroup STM32WL3R_NUCLEO_COMMON_Private_Defines STM32WL3R_NUCLEO COMMON Private Defines
  * @{
  */
...
/** @defgroup STM32WL3R_NUCLEO_COMMON_Private_TypesDefinitions STM32WL3R_NUCLEO COMMON Private Types Definitions
  * @{
  */
/**
  * @}
...
/** @defgroup STM32WL3R_NUCLEO_COMMON_Private_FunctionPrototypes STM32WL3R_NUCLEO COMMON Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32WL3R_NUCLEO_COMMON_Exported_Variables STM32WL3R_NUCLEO COMMON Exported Variables
  * @{
  */
#if (USE_BSP_COM_FEATURE == 1)
...
/** @defgroup STM32WL3R_NUCLEO_COMMON_Private_Variables STM32WL3R_NUCLEO COMMON Private Variables
  * @{
  */
...
/**
  * @brief  This method returns the STM32WL3R NUCLEO BSP Driver revision.
  * @retval version : 0xXYZR (8bits for each decimal, R for RC).
  */
int32_t BSP_GetVersion(void)
{
  return ((int32_t)STM32WL3R_NUCLEO_BSP_VERSION);
}
...
{
  return (const uint8_t*)STM32WL3R_NUCLEO_BSP_BOARD_NAME;
}
...
{
  return (const uint8_t*)STM32WL3R_NUCLEO_BSP_BOARD_ID;
}

/** @defgroup STM32WL3R_NUCLEO_COMMON_LED_Functions STM32WL3R_NUCLEO COMMON LED Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE == 1)
/** @defgroup STM32WL3R_NUCLEO_COMMON_COM_Functions STM32WL3R_NUCLEO COMMON COM Functions
  * @{
  */
...
/** @defgroup STM32WL3R_NUCLEO_COMMON_Private_Functions STM32WL3R_NUCLEO COMMON Private Functions
  * @{
  */
