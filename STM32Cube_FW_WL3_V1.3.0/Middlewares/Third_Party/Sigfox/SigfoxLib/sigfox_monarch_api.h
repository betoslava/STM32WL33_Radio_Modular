...
#define MAX_MONARCH_PATTERN_PER_FREQUENCY_SEARCH (sfx_u8)(2) /* On 1 frequency, we can at the maximum ask for the research of 2 different patterns */
